  ...
  $(function(){
  	...
  	var drawIt = function() {
  		...
  		$("#doughnutChart").drawDoughnutChart([
  			...
  			{ title: "Beta Tester", 	value:  4,   color:  colors[1] },
  			{ title: "Game Developer",      value:  dif(vyvanse, date2),   color:  colors[2] },
  			{ title: "Professional Chef",        value : dif(bakery, frog),   color:  colors[3] },
  			...
  			{ title: "Secret Program",        value : dif(frog, new Date(2016,0,4)),   color:  colors[6] }
  		]);
  	};

...
When I discovered Exponent, I couldn't put it down. I built everything I could think of, and I never really stopped. I'm still doing it [today](https://x.com/Baconbrix/status/2057913722371547163?s=20). That obsession turned out to be the most useful thing I brought to the job, because if you use your own product constantly, you feel every rough edge before anyone has to report it.

It sounds obvious, but you can always dogfood more. And the real signal is noticing when you _don't_ use it, then asking why. Every time I caught myself avoiding my own tools, there was a list of subtle problems hiding underneath.

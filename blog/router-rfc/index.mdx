<Title date="2022-09-27T00:31:23.913Z">RFC: File-Based Routing in React Native</Title>
...
![](./images/1YzCMKjZ6pS63hS-N_efNxg.avif)
...
![](./images/1iLEJMJ2uFG_CfzdkTrotjQ.avif)
...
![Navigation is truly native and optimized for iOS and Android](./images/1pIlbQ1TbALbsTKH-ibhYOA.avif)
...
![React Error Boundaries can be nested in layouts enabling users to navigate away or retry the page.](./images/1wCKlTNGpkSBU0Uktj6HVmA.avif)
...
![Apache index throwback](./images/1iNCWIvukczHDJKPYsAFx-A.avif)
...
![Virtual pages have a recurring theme.](./images/1gWG4Lvi9bcp-yyDVEi4jbw.avif)

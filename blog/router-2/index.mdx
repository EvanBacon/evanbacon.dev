...
To get started, refer to the [Expo Router documentation](https://docs.expo.dev/routing/introduction/). Please report bugs and issues on the [Expo Router GitHub repository](https://github.com/expo/router).

🚀 Follow us on Twitter for more updates: [expo](https://twitter.com/expo).
⭐️ Help us out by [starring Expo on GitHub](https://github.com/expo/expo), filing bug reports in issues, or opening discussions with questions or proposals.

...
export const Podcasts = [
    { url: "https://devchat.tv/react-native-radio/react-native-at-expo-feat-evan-bacon/", title: 'React Native Radio' },
    { url: "https://undefined.fm/radio/react-native-web-with-expos-evan-bacon", title: 'Undefined Podcast' },
    { url: "https://modernlife.network/interview-with-lego-builder-evan-bacon/", title: 'Behind the brick with Evan Bacon (2012)' },
]
...
export const Stories = [
    ...
    { url: "http://www.mtv.com/news/2623063/13-year-old-wins-awards-for-life-size-lego-batman/", title: 'MTV at age 13' },
...
export const Lego = [
    {
        ...
        awards: ['Best Youth Creation', 'Best Artistic Creation', `People's choice award`],
...
export const Talks = [
    ...
    },
    {
        ...
        description: "Expo is on a mission to create the best possible end-to-end developer experiences for building and deploying apps on multiple platforms. Today we are very excited to announce experimental web support for the Expo CLI and SDK!",
        presentedData: [
            {
                title: "App.js Conf",
    ...
    },
    {
        ...
        description: "Creating augmented reality apps with Expo is exciting and easy! We'll discuss how it's possible, what you can do with it, and why React Native + AR is an exciting new approach.",
        presentedData: [
            {
    ...
    },
    {
        ...
        description: "In this expo symposium (exposium) 🎙 we shall cordially discuss the usage of recreational cyber-gaming frameworks and their place in the native development environment.📱👾",
        presentedData: [
            {
                title: "React Europe",

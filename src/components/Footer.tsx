...
import { useIsFullScreenRoute } from './useIsFullScreenRoute';
import CenterInFull from './center-in-full';

function PossiblyCenter({ children }: { children: React.ReactNode }) {
  ...
  return <CenterInFull>{children}</CenterInFull>;
}
